...
<nav style="background-color: #eee2dc;" class="navbar navbar-expand-lg">
 ...
 {{-- navbar ends here --}}
    ...
    <footer>
      ...
      <a class="text-dark" href="https://github.com/Ganesh-Ghadi/QuickNote"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
